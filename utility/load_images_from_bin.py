...
if __name__=='__main__':
    ...
    if data_type == 'evaluation':
        ...
        rec_path = os.path.join(data_dir, 'faces_webface_112x112')
        load_mx_rec(rec_path)
        
        dataset = os.path.join(data_dir, 'faces_webface_112x112', 'image')
        list = os.path.join(data_dir, 'faces_webface_112x112', 'train.list')
